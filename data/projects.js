...
export const projectsData = [
 ...
 {
    id: 1,
    title: "CECL Credit Risk Analytics — LendingClub Portfolio",
    description: "End-to-end CECL-compliant credit risk platform for a $11.7B LendingClub consumer lending portfolio (1.35M loans, 2007-2018). Developed PD scorecard (AUC 0.693) and XGBoost ensemble (AUC 0.720, 50 SHAP-selected features), two-stage LGD (MAE 7.6%), and EAD models. Built synthetic monthly panel (31.4M rows) for institutional-format receivables tracking and forward default flow rates across 7 DPD buckets. Implemented 3-scenario macro stress testing with multi-quarter UNRATE paths, producing probability-weighted ECL across Pre-FEG, Central, and Post-FEG views ($2.9B Post-FEG, 64.6% ECL variance under stress). All population stability indices GREEN (PSI < 0.04).",
    category: "credit",
    technologies: ["Python", "XGBoost", "LightGBM", "Scikit-learn", "Pandas", "NumPy", "SHAP", "FRED API", "Kaplan-Meier", "Matplotlib"],
    github: "https://github.com/harshvardhan-sekar/lendingclub-credit-risk",
    demo: "#",
  ...
  },
  {
    ...
    github: "https://drive.google.com/file/d/176nY2Bf56dQNvr8C3Mz0x85lDafx_BWV/view",
    demo: "#",
    image: "fas fa-x-ray",
